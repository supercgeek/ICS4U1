...
<body>
	...
	<p>
		<span class="h1"><b>This is an h1 heading</b></span>
		<br>
		<br>

		<span class="p">
			This activity involves creating HTML code that will reproduce this output accurately. The body has a 10px padding around the whole thing and the font is "Century Gothic." There is a background-image: url("http://ics.actonhighschool.ca/test/images/fence.jpg"); as well. The default links have a link, visited, and active color of 3e3e3e and text-decoration underline. The hover state color is #ffffff (white), no text-decoration and background­color of #9400d3.</span>
		<hr>
		<span class="h2">HTML is Easy To Learn (h2 title)</span>
		<hr>
		<span class="p">Welcome to the world of the <b> World Wide Web</b>. This is the first paragraph. While short it is still a paragraph!</span>
		<br>
		<br>

		<span class="p">This is the second paragraph. It is also short and boring. Let's create a link to the <a href="http://www.w3schools.com/html/html_quick.asp">HTML Quick Reference List</a></span>
		<br>
		<br>

		<span class="p">In the third paragraph we'll try line breaks...<br>
H<br>
e<br>
l<br>
l<br>
o<br>
<br>
</span> Let's create two different types of links.
